export function createSetMusicVolumeTool({ music }) {
  return { definition: { type: "function", function: {
    name: "music_set_volume", description: "Establece o cambia el volumen del destino activo o mencionado en Music Assistant.",
  ...
  } }, execute: ({ volumePercent, changePercent, destination }, context = {}) => music.setVolume(volumePercent, destination, changePercent, context.satelliteId) };
}
